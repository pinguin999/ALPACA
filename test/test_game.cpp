...
//                     {
//                         if (std::string(obj->bounds->boundingBoxes[j]->super.super.name) !=
//                         "walkable_area" &&
//                             std::string(obj->bounds->boundingBoxes[j]->super.super.name) !=
//                             "non_walkable_area" &&
//                             std::string(obj->bounds->boundingBoxes[j]->super.super.name) !=
//                             "setDE" &&
//                             std::string(obj->bounds->boundingBoxes[j]->super.super.name) !=
...
//                             options +=
//                             std::string(obj->bounds->boundingBoxes[j]->super.super.name) + ", ";
//                             actions.emplace_back(std::string(obj->bounds->boundingBoxes[j]->super.super.name),
//                             obj);
//                         }
//                     }
//                 }
